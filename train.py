...
for epoch in range(MAX_EPOCHS):
    ...
    epoch_grad_clip_fraction = epoch_grad_clip_fired / max(n_batches, 1)
    ...
    print(
        ...
        f"train[vol={epoch_vol:.4f} surf={epoch_surf:.4f} gn_mean={epoch_grad_mean:.2f} gn_max={epoch_grad_max:.2f} clip_frac={epoch_grad_clip_fraction:.3f}]  "
