...
def evaluate_split_with_nan_workaround(model, loader, stats, surf_weight, device) -> dict[str, float]:
...
if best_metrics:
    ...
    if not cfg.skip_test:
        ...
        test_metrics_clean = {
            name: evaluate_split_with_nan_workaround(model, loader, stats, cfg.surf_weight, device)
            for name, loader in test_loaders.items()
        }
