...
```bash
python ./train.py --epochs 999 --agent ml-intern-r5 --wandb_group mlintern-pai2-72h-v4-r5 --wandb_name "mlintern-pai2-72h-v4-r5/<short-description>"
```
...
Before finishing, commit and push to `mlintern-pai2-72h-v4-r5`:
