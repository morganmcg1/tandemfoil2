...
```bash
python ./train.py --epochs 999 --agent ml-intern-r4 --wandb_group mlintern-pai2-24h-v3-r4 --wandb_name "mlintern-pai2-24h-v3-r4/<short-description>"
```
...
Before finishing, commit and push to `mlintern-pai2-24h-v3-r4`:
