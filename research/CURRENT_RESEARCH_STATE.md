...
| fern     | #453 | pchannel-p-ramp05-10 | Loss weighting (linear ramp w_p 0.5→1.0) | -2% to -7% | **CLOSED** — paired -1.80% (within noise); rebase missed FiLM/warmup; absolute 57.86 lags merged 54.12 by +6.9% |
| fern     | #658 | adamw-beta2-sweep | Optimizer (AdamW β₂ ∈ {0.95, 0.99, 0.995, 0.999}) | -1% to -3% | WIP |
