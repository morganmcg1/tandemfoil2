...
| **#727** | **thorfinn** | **Optimizer numerics** | **AdamW eps=1e-7 probe** (default 1e-8 since round 1). Pivot from rc-targeted input-side work to optimizer/schedule axis after 4 rc-targeted PRs underperformed. |
