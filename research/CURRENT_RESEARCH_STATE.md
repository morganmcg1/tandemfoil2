...
| fern     | #453 | pchannel-p-ramp05-10 | Loss weighting (linear ramp w_p 0.5→1.0 over training) | -2% to -7% | WIP |
...
| frieren  | #477 | wider144-compile | Architecture (n_hidden 128→144 under post-#289) | -2% to -7% | WIP |
